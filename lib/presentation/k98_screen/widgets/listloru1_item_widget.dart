...
class Listloru1ItemWidget extends StatelessWidget {
  Listloru1ItemWidget(this.listloru1ItemModelObj);

  Listloru1ItemModel listloru1ItemModelObj;

  var controller = Get.find<K98Controller>();
