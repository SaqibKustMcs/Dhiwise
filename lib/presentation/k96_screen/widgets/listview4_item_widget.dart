...
import '../models/listview4_item_model.dart';
import 'package:flutter/material.dart';
import 'package:saqi_s_application1/core/app_export.dart';

// ignore: must_be_immutable
class Listview4ItemWidget extends StatelessWidget {
  Listview4ItemWidget(this.listview4ItemModelObj);

  Listview4ItemModel listview4ItemModelObj;

  var controller = Get.find<K96Controller>();
