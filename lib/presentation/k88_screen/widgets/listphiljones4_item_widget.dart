...
import '../models/listphiljones4_item_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:saqi_s_application1/core/app_export.dart';

// ignore: must_be_immutable
class Listphiljones4ItemWidget extends StatelessWidget {
  Listphiljones4ItemWidget(this.listphiljones4ItemModelObj);

  Listphiljones4ItemModel listphiljones4ItemModelObj;
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          ...
                          overflow: TextOverflow.ellipsis,
                          textAlign: TextAlign.left,
                          style: AppStyle.txtDMSansMedium10Gray9007f.copyWith(),
                        ),
                      ),
                      Container(
                        margin: getMargin(
