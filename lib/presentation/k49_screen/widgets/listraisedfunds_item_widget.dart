...
class ListraisedfundsItemWidget extends StatelessWidget {
  ListraisedfundsItemWidget(this.listraisedfundsItemModelObj);

  ListraisedfundsItemModel listraisedfundsItemModelObj;
