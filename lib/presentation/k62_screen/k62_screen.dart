import '../k62_screen/widgets/listphiljones2_item_widget.dart';
import '../k62_screen/widgets/listprice3_item_widget.dart';
import 'controller/k62_controller.dart';
import 'models/listphiljones2_item_model.dart';
                                          ...
                                          child: Obx(
                                            () => ListView.builder(
                                              ...
                                              itemBuilder: (context, index) {
                                                Listprice3ItemModel model =
                                                    controller.k62ModelObj.value
                                                            .listprice3ItemList[
                                                        index];
                                                return Listprice3ItemWidget(
                                                  model,
                                                );
                                              },
                                            ),
                            ...
                            child: Padding(
                              ...
                              child: Obx(
                                () => ListView.builder(
                                  physics: BouncingScrollPhysics(),
                                  shrinkWrap: true,
                                  itemCount: controller.k62ModelObj.value
                                      .listphiljones2ItemList.length,
                                  itemBuilder: (context, index) {
                                    Listphiljones2ItemModel model = controller
                                        .k62ModelObj
                                        .value
                                        .listphiljones2ItemList[index];
                                    return Listphiljones2ItemWidget(
                                      model,
                                    );
                                  },
                                ),
