import '../k31_screen/widgets/listcheckmark2_item_widget.dart';
                                        ...
                                        child: Obx(
                                          () => ListView.separated(
                                            ...
                                            itemCount: controller
                                                .k31ModelObj
                                                .value
                                                .listcheckmark2ItemList
                                                .length,
                                            itemBuilder: (context, index) {
                                              Listcheckmark2ItemModel model =
                                                  controller.k31ModelObj.value
                                                          .listcheckmark2ItemList[
                                                      index];
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      CustomButton(
                                        ...
                                        variant: ButtonVariant.FillCyan500,
                                        shape: ButtonShape.CustomBorderLR50,
                                        padding: ButtonPadding.PaddingAll10,
                                      ),
                                      CustomButton(
                                        width: 125,
                                        text: "lbl_updates2".tr,
                                        margin: getMargin(
                                          top: 12,
                                          right: 10,
                                        ),
                                        variant: ButtonVariant.FillTeal500,
                                        shape: ButtonShape.CustomBorderLR50,
                                        padding: ButtonPadding.PaddingAll10,
                                      ),
                                      CustomButton(
