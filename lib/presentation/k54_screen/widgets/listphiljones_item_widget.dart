...
class ListphiljonesItemWidget extends StatelessWidget {
  ListphiljonesItemWidget(this.listphiljonesItemModelObj);

  ListphiljonesItemModel listphiljonesItemModelObj;
